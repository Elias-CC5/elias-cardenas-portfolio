...
const skills: { name: string; category: 'FRONTEND' | 'BACKEND' | 'DATABASE' | 'TOOLS'; order: number }[] = [
  ...
  { name: 'Astro', category: 'FRONTEND', order: 3 },
  { name: 'TypeScript', category: 'FRONTEND', order: 4 },
  { name: 'JavaScript (ES6+)', category: 'FRONTEND', order: 5 },
  { name: 'HTML5', category: 'FRONTEND', order: 6 },
  { name: 'Tailwind CSS', category: 'FRONTEND', order: 7 },
  { name: 'Bootstrap', category: 'FRONTEND', order: 8 },
  { name: 'Vite', category: 'FRONTEND', order: 9 },
  { name: 'Axios', category: 'FRONTEND', order: 10 },
  { name: 'C++', category: 'FRONTEND', order: 11 },
  ...
  { name: 'Visual Studio Code', category: 'TOOLS', order: 4 },
  { name: 'IntelliJ IDEA', category: 'TOOLS', order: 5 },
  { name: 'Android Studio', category: 'TOOLS', order: 6 },
  { name: 'Xcode', category: 'TOOLS', order: 7 },
  { name: 'npm', category: 'TOOLS', order: 8 },
